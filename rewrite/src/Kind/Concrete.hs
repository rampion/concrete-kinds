...
type family Void = (void :: object) | void -> object where
  Void = Shadowed.Void
  Void = Nullary Shadowed.Void

data family Arrow :: object -> object -> *
data family Nullary (a :: *) :: j -> k
...
newtype instance Nullary a x = Nullary1 { getNullary1 :: a }
...
newtype instance Nullary a x y = Nullary2 { getNullary2 :: a }
...
newtype instance Nullary a x y z = Nullary3 { getNullary3 :: a }
